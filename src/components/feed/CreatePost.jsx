  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (selectedImage) {
        ...
        // Use display_url as it's optimized for viewing
        uploadedImageUrl = data.data.display_url || data.data.url;
      }
    ...
    <div className="_feed_inner_text_area _b_radious6 _padd_b24 _padd_t24 _padd_r24 _padd_l24 _mar_b16">
      <div className="_feed_inner_text_area_box">
        <div className="_feed_inner_text_area_box_image">
          <img src="/src/assets/images/txt_img.png" alt="Image" className="_txt_img" />
        </div>
      ...
      <div className="_feed_inner_text_area_bottom">
        <div className="_feed_inner_text_area_item">
          ...
          <div className="_feed_inner_text_area_bottom_video _feed_common" title="Video upload is currently disabled">
            <button type="button" className="_feed_inner_text_area_bottom_photo_link" disabled style={{ opacity: 0.5, cursor: 'not-allowed' }}> 
              <span className="_feed_inner_text_area_bottom_photo_iamge _mar_img">   
