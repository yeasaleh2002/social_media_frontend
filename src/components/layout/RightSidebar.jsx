            ...
            <div className="_right_inner_area_info_ppl">
              <div className="_right_inner_area_info_box">
                <div className="_right_inner_area_info_box_image">
                  <Link to="/profile">
                    <img src="/src/assets/images/Avatar.png" alt="Image" className="_ppl_img" />
                  </Link>
                </div>
            ...
            <div className="_feed_top_fixed">
              <div className="_feed_right_inner_area_card_content _mar_b24">
                ...
                <span className="_feed_right_inner_area_card_content_txt">
                  <Link className="_feed_right_inner_area_card_content_txt_link" to="/find-friends">See All</Link>
                </span>
              </div>
            ...
            <div className="_feed_bottom_fixed">
              <div className="_feed_right_inner_area_card_ppl _feed_right_inner_area_card_ppl_inactive ">
                <div className="_feed_right_inner_area_card_ppl_box">
                  <div className="_feed_right_inner_area_card_ppl_image">
                    <Link to="/profile">
                      <img src="/src/assets/images/people1.png" alt="" className="_box_ppl_img" />
                    </Link>
                  </div>
              ...
              <div className="_feed_right_inner_area_card_ppl">
                <div className="_feed_right_inner_area_card_ppl_box">
                  <div className="_feed_right_inner_area_card_ppl_image">
                    <Link to="/profile">
                      <img src="/src/assets/images/people2.png" alt="" className="_box_ppl_img" />
                    </Link>
                  </div>
                  <div className="_feed_right_inner_area_card_ppl_txt">
                    <Link to="/profile">
              ...
              <div className="_feed_right_inner_area_card_ppl">
                <div className="_feed_right_inner_area_card_ppl_box">
                  <div className="_feed_right_inner_area_card_ppl_image">
                    <Link to="/profile">
                      <img src="/src/assets/images/people3.png" alt="" className="_box_ppl_img" />
                    </Link>
                  </div>
                  <div className="_feed_right_inner_area_card_ppl_txt">
                    <Link to="/profile">
