        ...
        <div className="_layout_left_sidebar_inner">
          <div className="_left_inner_area_explore _padd_t24  _padd_b6 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area">
            ...
            <ul className="_left_inner_area_explore_list">
              ...
              <li className="_left_inner_area_explore_item">
                <Link to="/find-friends" className="_left_inner_area_explore_link">
                  <svg xmlns="http://www.w3.org/2000/svg" width="22" height="24" fill="none" viewBox="0 0 22 24">
              ...
              <li className="_left_inner_area_explore_item">
                <Link to="/group" className="_left_inner_area_explore_link">
          ...
          <div className="_left_inner_area_suggest _padd_t24  _padd_b6 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area">
            ...
            <div className="_left_inner_area_suggest_info">
              <div className="_left_inner_area_suggest_info_box">
                <div className="_left_inner_area_suggest_info_image">
                  <Link to="/profile/1">
                    <img src="/src/assets/images/people1.png" alt="Image" className="_info_img" />
                  </Link>
                </div>
              ...
              <div className="_left_inner_area_suggest_info_link"> 
                <Link to="#0" className="_info_link">Connect</Link>
              </div>
            </div>
            ...
            <div className="_left_inner_area_suggest_info">
              <div className="_left_inner_area_suggest_info_box">
                <div className="_left_inner_area_suggest_info_image">
                  <Link to="/profile/2">
                    <img src="/src/assets/images/people2.png" alt="Image" className="_info_img1" />
                  </Link>
                </div>
                <div className="_left_inner_area_suggest_info_txt">
                  <Link to="/profile/2">
            ...
            <div className="_left_inner_area_suggest_info">
              <div className="_left_inner_area_suggest_info_box">
                <div className="_left_inner_area_suggest_info_image">
                  <Link to="/profile/3">
                    <img src="/src/assets/images/people3.png" alt="Image" className="_info_img1" />
                  </Link>
                </div>
                <div className="_left_inner_area_suggest_info_txt">
                  <Link to="/profile/3">
        ...
        <div className="_layout_left_sidebar_inner">
          <div className="_left_inner_area_event _padd_t24  _padd_b6 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area">
            <div className="_left_inner_event_content">
              ...
              <Link to="/event" className="_left_inner_event_link">See all</Link>
            </div>
            <Link className="_left_inner_event_card_link" to="/event-single">
              <div className="_left_inner_event_card">
                <div className="_left_inner_event_card_iamge">
                  <img src="/src/assets/images/feed_event1.png" alt="Image" className="_card_img" />
                </div>
                ...
                <div className="_left_inner_event_bottom">
                  ...
                  <Link to="#0" className="_left_iner_event_bottom_link">Going</Link>
                </div>
              </div>
            </Link>
            <Link className="_left_inner_event_card_link" to="/event-single">
