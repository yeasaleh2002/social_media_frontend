...
export default function Navbar() {
  ...
  const displayPic = user?.profilePicture || "/src/assets/images/profile.png";
        ...
        <div className="container _custom_container">
          <div className="_logo_wrap">
            <Link className="navbar-brand" to="/feed">
              <img src="/src/assets/images/logo.svg" alt="Image" className="_nav_logo" />
            </Link>
          </div>
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul className="navbar-nav mb-2 mb-lg-0 _header_nav_list ms-auto _mar_r8">
              ...
              <li className="nav-item _header_nav_item">
                <span id="_notify_btn" className="nav-link _header_nav_link _header_notify_btn" onClick={() => setNotifyOpen(!notifyOpen)}>
                      ...
                      <div className="_notifications_all">
                        ...
                        <div className="_notification_box">
                          <div className="_notification_image">
                            <img src="/src/assets/images/friend-req.png" alt="Image" className="_notify_img" />
                          </div>
            ...
            <div className="_header_nav_profile">
              ...
              >
                <div className="_header_nav_profile_image">
                  <img src={displayPic} alt="Profile" className="_nav_profile_img" style={{ width: '40px', height: '40px', objectFit: 'cover', borderRadius: '50%' }} />
                </div>
                <div className="_header_nav_dropdown ms-2 d-flex align-items-center">
                  <p className="_header_nav_para mb-0 me-2">{displayName}</p>
                  <button id="_profile_drop_show_btn" className="_header_nav_dropdown_btn _dropdown_toggle p-0 bg-transparent border-0" type="button">
                    <svg xmlns="http://www.w3.org/2000/svg" width="10" height="6" fill="none" viewBox="0 0 10 6" style={{ transform: profileDrop ? 'rotate(180deg)' : 'rotate(0deg)', transition: 'transform 0.2s' }}>
              ...
              <div id="_prfoile_drop" className="_nav_profile_dropdown _profile_dropdown show">
                <div className="_nav_profile_dropdown_info">
                  <div className="_nav_profile_dropdown_image">
                    <img src={displayPic} alt="Profile" className="_nav_drop_img" style={{ width: '50px', height: '50px', objectFit: 'cover', borderRadius: '50%' }} />
                  </div>
                ...
                <ul className="_nav_dropdown_list">
                  ...
                  <li className="_nav_dropdown_list_item">
                    <a href="#0" onClick={handleLogout} className="_nav_dropdown_link">
                      <div className="_nav_drop_info">
                        <span>
                ...
                <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                  <div className="_header_mobile_menu_top_inner">
                    ...
                    <div className="_header_mobile_menu_right">
                      <form className="_header_form_grp">
                        <Link to="#0" className="_header_mobile_search"> 
