            ...
            <div className="col-xl-12 col-lg-12 col-md-12">
              <ul className="_mobile_navigation_bottom_list">
                <li className="_mobile_navigation_bottom_item">
                  <Link to="/feed" className={`_mobile_navigation_bottom_link ${location.pathname === '/feed' ? '_mobile_navigation_bottom_link_active' : ''}`}>
                ...
                <li className="_mobile_navigation_bottom_item">
                  <Link to="/friend-request" className={`_mobile_navigation_bottom_link ${location.pathname === '/friend-request' ? '_mobile_navigation_bottom_link_active' : ''}`}>
